...
const array = ['anthas','aysheri','endhada','help','myre','myree','poda','chirikkjunnoda','endha','endhpatti','kalla','killadi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
